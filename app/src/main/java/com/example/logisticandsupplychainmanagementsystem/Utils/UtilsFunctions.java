package com.example.logisticandsupplychainmanagementsystem.Utils;
...
public class UtilsFunctions {
    ...
    public static void showLongToast(Context context, String string) {
        Toasty.success(context , string , Toasty.LENGTH_LONG).show();
    }
    ...
    public static void showLongToastError(Context context, String string) {
        Toasty.error(context , string , Toasty.LENGTH_LONG).show();
    }
    ...
    public static void showLongToastWarning(Context context, String string) {
        Toasty.warning(context , string , Toasty.LENGTH_LONG).show();
    }
    ...
    public static void showLongToastInfo(Context context, String string) {
        Toasty.info(context , string , Toasty.LENGTH_LONG).show();
    }
